...
mixin TeamOptionsPopopWidgetProvider on StatelessWidget {
  Widget provideUsing(BuildContext context, GlobalScoreboard scoreboardState,
...
class __TeamIndexCounterState extends State<_TeamIndexCounter> {
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
        ...
        child: SizedBox(
            child: _buildTeamControls(
                context, scoreboardState, displayCharacterstics, textTheme)));
  }
                ...
                child: ElevatedButton(
                    child: Text(_currentTeamName,
                        ...
                        style: textTheme.displayMedium?.apply(
                            color: colorScheme.onPrimary, fontWeightDelta: 3),
